...
ALTER TABLE user_progress 
ADD CONSTRAINT IF NOT EXISTS fk_user_progress_course 
FOREIGN KEY (course_id) REFERENCES courses(id) ON DELETE CASCADE;

ALTER TABLE user_progress 
ADD CONSTRAINT IF NOT EXISTS fk_user_progress_chapter 
FOREIGN KEY (chapter_id) REFERENCES chapters(id) ON DELETE CASCADE;

-- Add the unique constraint
ALTER TABLE user_progress 
ADD CONSTRAINT IF NOT EXISTS user_progress_user_id_course_id_chapter_id_key 
